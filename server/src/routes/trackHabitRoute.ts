...
import {  getHabitTrackers, upsertHabitStatus } from '../controllers/trackHabitController'
...
router.put("/:_id", verifyJWT, trackHabitValidationForUpdating, validateRequest, upsertHabitStatus)
